...
import miram from "../images/people/miram.png";
import michael from "../images/people/michael.png";
import joydeep from "../images/people/joydeep.png";

import rajeev from "../images/people/rajeev.png";
import suraj from "../images/people/suraj.png";
import bhatt from "../images/people/bhatt.png";
import gavin from "../images/people/gavin.png";
import cameron from "../images/people/cameron.png";
import cathy from "../images/people/cathy.png";
import seth from "../images/people/seth.png";
import alex from "../images/people/alex.png";
import doreen from "../images/people/doreen.png";
import mark from "../images/people/mark.png";
import ben from "../images/people/ben.png";
import kasia from "../images/people/kasia.png";
import tim from "../images/people/tim.png";
import julia from "../images/people/julia.png";
import ashley from "../images/people/ashley.png";
import phil from "../images/people/phil.png";
import kara from "../images/people/kara.png";
import female from "../images/people/female.png";
import male from "../images/people/male.png";
  ...
  return (
    ...
    >
      <ModalHeader>
        ...
        <ModalPersonName style={{ fontSize: "32px" }}>
          {props.person.name}
        </ModalPersonName>
      ...
      <ModalContent>
        ...
        <br />
        <MediumBody>{props.person.biography1}</MediumBody>
        <MediumBody>{props.person.biography2}</MediumBody>
      </ModalContent>
    </StyledBiographyModal>
  );
}
    ...
    <Layout title="About">
      ...
      <Row style={{ backgroundColor: "#f6f6f6", paddingBottom: 0 }}>
        ...
        <AboutPeopleGrid>
          ...
          >
            <img src={manoj} alt="Manoj Saxena" />
          ...
          >
            <img src={michael} alt="Michael E. Stewart" />
          ...
          >
            <img src={joydeep} alt="Dr. Joydeep Ghosh" />
      ...
      <Row style={{ backgroundColor: "#f6f6f6", paddingBottom: 0 }}>
        ...
        <AboutPeopleGrid>
          ...
          >
            <img src={rajeev} alt="Rajeev Ronanki" />{" "}
            <PersonName>Rajeev Ronanki</PersonName>
            <PersonPosition>Advisor, Anthem, Inc.</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={bhatt} alt="Dr. Bhatt Vadlamani" />{" "}
            <PersonName>Dr. Bhatt Vadlamani</PersonName>
            <PersonPosition>Advisor, Jackson Enterprise</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={gavin} alt="Gavin Munroe" />{" "}
            <PersonName>Gavin Munroe</PersonName>
            <PersonPosition>Advisor, HSBC</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={cameron} alt="Cameron Davies" />{" "}
            <PersonName>Cameron Davies</PersonName>
            <PersonPosition>Advisor, NBCUniversal</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={cathy} alt="Cathy Cobey" />{" "}
            <PersonName>Cathy Cobey</PersonName>
            <PersonPosition>Advisor, EY</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
                ...
                biography1:
                  "Seth Dobrin is the vice president and chief data officer for IBM Analytics, where he is responsible for the transformation of the analytics business operations using data and analytics, influencing IBM Analytics offerings to meet the needs of CDOs, and providing his perspective and experiences to clients. Seth has spent his career scaling and combining existing technologies to address previously intractable problems at scale. Previously, he led the data science transformation of a Fortune 500 company, as well as the company’s Agile transformation and their shift to the cloud, and oversaw efforts to leverage the data science transformation to drive new business models to create new revenue streams, along with the optimization of existing processes.",
                biography2:
                  "He has served as a member of the advisory board for IBM’s Spark Technology Center, is a founding member of the International Society of Chief Data Officers, and has been a prolific panelist at the East and West Chief Data Officer Summits. Seth holds a PhD in genetics from Arizona State University, where he focused on the application of statistical and molecular genetics toward the elucidation of the causes of neuropsychiatric disorders. In these efforts, he was involved in some of the first applications of machine learning to large-scale genetic analysis.",
              })
            }
          >
            <img src={seth} alt="Seth Dobrin" />{" "}
            <PersonName>Seth Dobrin</PersonName>
            <PersonPosition>Advisor, IBM</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={alex} alt="Alex Benay" />{" "}
            <PersonName>Alex Benay</PersonName>
            <PersonPosition>Advisor, Microsoft</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={doreen} alt="Doreen Lorenzo" />{" "}
            <PersonName>Doreen Lorenzo</PersonName>
            <PersonPosition>Advisor, UT Austin</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={mark} alt="Mark Rolston" />{" "}
            <PersonName>Mark Rolston</PersonName>
            <PersonPosition>Advisor, argodesign</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={ben} alt="Ben Lamm" /> <PersonName>Ben Lamm</PersonName>
            <PersonPosition>Advisor, Hypergiant</PersonPosition>
          </PersonContainer>
        </AboutPeopleGrid>
      </Row>
      <Row style={{ backgroundColor: "#f6f6f6", paddingBottom: 0 }}>
        ...
        <AboutPeopleGrid>
          ...
          >
            <img src={kasia} alt="Kasia Chmielinski" />{" "}
            <PersonName>Kasia Chmielinski</PersonName>
            <PersonPosition>Data Advisor, DNP</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={tim} alt="Tim Vincent" />{" "}
            <PersonName>Tim Vincent</PersonName>
            <PersonPosition>Technical Advisor, IBM</PersonPosition>
          </PersonContainer>
          <PersonContainer
            onClick={() =>
              openModal({
          ...
          >
            <img src={julia} alt="Julia Stoyanovich" />{" "}
            <PersonName>Julia Stoyanovich</PersonName>
            <PersonPosition>Technical Advisor, NYU</PersonPosition>
          </PersonContainer>
        </AboutPeopleGrid>
      </Row>
      <Row>
