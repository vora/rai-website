...
function About(props) {
  ...
  return (
    <Layout title="About RAIL">
            ...
            return (
              <>
                <PersonContainer onClick={() => openModal(board)}>
                  ...
                  <PersonName>{board.name}</PersonName>
                  <PersonPosition>{board.position}</PersonPosition>
                </PersonContainer>
              </>
            );
          })}
            ...
            return (
              <>
                <PersonContainer onClick={() => openModal(advisor)}>
                  ...
                  />
                  {/* <PersonImage src="../images/pictures/about/jumboforeground.png"/> */}
                  <PersonName>{advisor.name}</PersonName>
                  <PersonPosition>{advisor.position}</PersonPosition>
                </PersonContainer>
              </>
            );
          })}
            ...
            return (
              <>
                <PersonContainer onClick={() => openModal(expertAdvisor)}>
                  ...
                  />
                  {/* <PersonImage src="../images/pictures/about/jumboforeground.png"/> */}
                  <PersonName>{expertAdvisor.name}</PersonName>
                  <PersonPosition>{expertAdvisor.position}</PersonPosition>
                </PersonContainer>
              </>
            );
          })}
            ...
            return (
              <>
                <PersonContainer onClick={() => openModal(leadership)}>
                  ...
                  />
                  {/* <PersonImage src="../images/pictures/about/jumboforeground.png"/> */}
                  <PersonName>{leadership.name}</PersonName>
                  <PersonPosition>{leadership.position}</PersonPosition>
                </PersonContainer>
              </>
            );
          })}
      ...
      <Row>
        <PartnerHeader>
          <PartnerHeadline>Members</PartnerHeadline>
          <PartnerLinkContainer>
            <PartnerLink
              selected={partnerSelected == "members"}
              onClick={() => setPartnerSelected("members")}
            >
              Members
            </PartnerLink>
            <PartnerLink
              selected={partnerSelected == "contributers"}
              onClick={() => setPartnerSelected("contributers")}
            >
              Contributers
            </PartnerLink>
            <PartnerLink
              selected={partnerSelected == "affliates"}
              onClick={() => setPartnerSelected("affliates")}
            >
              Affliates
            </PartnerLink>
          </PartnerLinkContainer>
